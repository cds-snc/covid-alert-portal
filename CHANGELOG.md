...
- Added 'supervisord' to the dockerfile in order to run multiple processes within the container.
  This currently includes the Django server and Cron. We use Cron to schedule the 
  clearing audit logs job.
