import os
from portal.settings import CREATE_DEFAULT_SU, SU_DEFAULT_PASSWORD, AUTH_PASSWORD_VALIDATORS
...
class Command(BaseCommand):
    ...
    def create_su(self):
        ...
        if validate_password(SU_DEFAULT_PASSWORD) == None:
            HealthcareUser.objects.create_superuser("hcw_portal_admin@cds-snc.ca","hcw_portal_admin", SU_DEFAULT_PASSWORD)
