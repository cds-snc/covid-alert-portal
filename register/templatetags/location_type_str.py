...
from ..forms import type_establishment, type_event, type_event_or_establishment, location_category_type_map
...
def location_type_str(location_category, prefix, * args, **kwargs):
    ...
    if prefix == 'address':
        ...
        elif location_category_type_map[location_category] == type_event_or_establishment:
