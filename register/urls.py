...
from . import views
from .forms import LocationCategoryForm, LocationNameForm, LocationAddressForm, LocationContactForm
...
location_wizard = views.LocationWizard.as_view(named_location_forms,
    url_name='register:location_step', done_step_name='summary')
...
urlpatterns = [
    ...
    re_path(r'^(?P<pk>.+)/location/(?P<step>.+)/$', location_wizard, name='location_step'),
